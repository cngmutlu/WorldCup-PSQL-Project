...
(SELECT winner_id as teams_id FROM games WHERE year = 2014 AND round = 'Eighth-Final' 
UNION ALL SELECT opponent_id as teams_id FROM games WHERE year = 2014 AND round = 'Eighth-Final') ORDER BY name")"
